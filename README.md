# u32-set
advanced STL::set&lt;uint32_t>, with 2x speed up

I have implemented the function `lower_bound`, `insert`, `count`, and `clear`

In my implementation, the space cost is roughly similar to that of set<int>.
